/**
 * VideoTaggerApp - Main application controller
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', async () => {
        const app = new VideoTaggerApp();
        window.videoTaggerApp = app; // Make accessible immediately for debugging/tests
        await app.ready; // Wait for initialization to complete
        console.log('VideoTaggerApp ready');
    });
} else {
    (async () => {
        const app = new VideoTaggerApp();
